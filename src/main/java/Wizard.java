...
Il componente Core Application ha la responsabilità di portare a termine le richieste utente.
Le classi principali che sono incluse in questo modulo software sono:
ControllerLibreria, l'interfaccia Command e tutti i comandi corrispondenti:
ComandoAggiungi, ComandoRimuovi, ComandoModifica, ComandoCarica, ComandoSalva, ComandoOrdina.


Il componente Model raggruppa quell'insieme di classi che rappresentano la Libreria a livello di modello.
Infatti le classi principali che sono incluse in questo modulo software sono le classi Libro e Libreria.



Il componente Persistance ha la responsabilità di salvare dati su memoria persistente e di caricare
dati da memoria persistente.
Le classi principali di questo componente software sono GestorePersistenza e StrategiaPersistenzaJson
(conforme all'interfaccia StrategiaPersistenza)





Il componente Model si interfaccia al componente Presenter tramite l'interfaccia IObserver.
Infatti, tramite il design pattern observer, quando la classe Libreria cambia il suo stato,
notifica i suoi osservatori, tra cui la classe VistaLibreriaRCA.


Il componente Presenter, una volta raccolta la richiesta utente, la spedisce al Controller,
che è in grado di processarla.
Per farlo, il componente Presenter si interfaccia con il componente CoreApplication tramite
l'interfaccia ControllerAPI, che consiste nei metodi pubblici che mette a disposizione il Controller.


Il componente Core Application è in grado di effettuare delle modifiche sugli oggetti a livello di modello,
per farlo si interfaccia al componente Model tramite l'interfaccia ModelAPI, che consiste
nei metodi pubblici che mette a disposizione la Libreria.



Il componente Core Application, inoltre, comunica con il componente Persistance tramite l'interfaccia
PersistanceAPI, che consiste dei metodi pubblici che mette a disposizione la classe GestorePersistenza.
