...
public class Wizard {
    ...
    public void mostraComandi() {
        String sb = "A)ggiungi un libro alla tua collezione" + "\n" +
                "M)odifica un libro della tua collezione" + "\n" +
                "R)imuovi un libro dalla tua collezione" + "\n" +
                "O)rdina la tua libreria" + "\n" +
                "F)iltra la libreria, mostrando i libri che soddisfano un particolare criterio" + "\n" +
                "T)rova libro per titolo/autore" + "\n" +
                "C)arica libreria da file" + "\n" +
                "S)alva libreria su file" + "\n" +
                "P)resenta comandi" + "\n" +
                "E)sci" + "\n";
        vista.mostraMenu(sb);
    }
    ...
    public void cerca() {
        ...
        vista.mostraMessaggio("Inserisci una parola contenuta nel titolo o nel nome dell'autore dei libri che vuoi cercare");
        vista.mostraMessaggio("Digita \"annulla\" in qualsiasi momento per annullare l'operazione");
