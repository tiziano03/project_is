...
public class TestDomain {
    ...
    @Nested
    @DisplayName("Test del Modello di Dominio: Libreria")
    class LibreriaTest {
        ...
        public void testSingleton(){
            Libreria lib1=Libreria.getInstance();
            lib1.aggiungiLibro(libroTolkien);
            lib1.aggiungiLibro(libroOrwell);
            lib1.aggiungiLibro(libroCoelho);
            Libreria lib2=Libreria.getInstance();
            Assertions.assertEquals(lib1, lib2);
        }
