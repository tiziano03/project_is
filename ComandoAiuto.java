public class ComandoAiuto implements Command{
    ...
    public void execute(ParsedInput input) {
        if (!input.getArgomentiNominali().isEmpty() || input.getArgomentiPosizionali().size() > 1){
            vistaLibreria.mostraMessaggio("Comando non riconosciuto!"+"\n"+"Rispetta la sintassi:<aiuto> oppure <aiuto> comando");
            return;
        }
        if (input.getArgomentiPosizionali().isEmpty())
            ...
            switch (argomento) {
                ...
                case "rimuovi":
                    ...
                    break;
                default:{
                    vistaLibreria.mostraMessaggio("" +argomento + " non è un comando per cui è supportata assistenza!"+"\n"
                    +"Comandi per cui è supportata assistenza: aggiungi, rimuovi, modifica, filtra, ordina");
                }
    ...
    public void aiutoGenerale(){
        ...
        sb.append("per ordinare la libreria secondo un criterio:<ordina> --<campo> campo"+"\n");
        ...
        sb.append("valori concessi per la valutazione: una_stella, due_stelle, tre_stelle, quattro_stelle, cinque_stelle, non_disponibile"+"\n");
    ...
    public void aiutoRimuovi(){
        ...
        sb.append("<rimuovi> --<isbn> isbn"+"\n");
        sb.append("esempio:"+"\n");
        sb.append("rimuovi --isbn 978-8871921501");
        String messaggio=sb.toString();
        vistaLibreria.mostraMessaggio(messaggio);
    }
    ...
    public void aiutoModifica(){
        ...
        sb.append("esempio:"+"\n");
        sb.append("modifica --isbn 978-8871921501 --campo valutazione --valore quattro_stelle");
        String messaggio=sb.toString();
        vistaLibreria.mostraMessaggio(messaggio);
    }
    ...
    public void aiutoOrdina(){
        ...
        sb.append("<ordina> --<campo> campo"+"\n");
        sb.append("esempio:"+"\n");
        sb.append("ordina --campo valutazione"+"\n");
